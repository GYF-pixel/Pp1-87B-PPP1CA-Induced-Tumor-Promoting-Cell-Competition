...
computeMatrix reference-point -S /storage/maxianjueLab/guoyifan/FTH/02Analysis/02ATAC-seq/06BigWig/F_normalized_BPM_20bin.bw \
							  ...
							  -o $projPath/08Deeptools/${histName}_TSS_Macs2_narrowPeak_data.gz

plotHeatmap -m $projPath/08Deeptools/${histName}_TSS_Macs2_narrowPeak_data.gz \
            --heatmapHeight 12 \
            ...
            -o $projPath/08Deeptools/${histName}_TSS_Macs2_narrowPeak_heatmap.pdf
	}
done
